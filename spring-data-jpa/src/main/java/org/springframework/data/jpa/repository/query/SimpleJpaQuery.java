...
final class SimpleJpaQuery extends AbstractStringBasedJpaQuery {
	...
	public SimpleJpaQuery(JpaQueryMethod method, EntityManager em, @Nullable String countQueryString,
			QueryRewriter queryRewriter, QueryPostProcessor queryPostProcessor,
			QueryMethodEvaluationContextProvider evaluationContextProvider, SpelExpressionParser parser) {
		this(method, em, method.getRequiredAnnotatedQuery(), countQueryString, queryRewriter, queryPostProcessor,
	...
	public SimpleJpaQuery(JpaQueryMethod method, EntityManager em, String queryString, @Nullable String countQueryString,
		...
		super(method, em, queryString, countQueryString, queryRewriter, queryPostProcessor, evaluationContextProvider,
				parser);
